...
<div class="page-full component-patientadd fx-column"> 
    <app-header :title="appHeader.title">
        <div slot="right" @click="savePatient" class="header-right-text ac-o">保存</div>
    </app-header>
...
export default {
    ...
    methods: {
        savePatient: function() {
            ...
            this.$store.dispatch('edit_patient', { patient: this.patient, index: this.$route.params.id});
    ...
    activated () {
        this.patient = Object.assign({}, this.patients[this.$route.params.id]);
    },
    created () {
